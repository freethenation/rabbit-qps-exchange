...
The 'qps-delay' header (in milliseconds) delays the message before routeing it to your queue (using the default exchange and your routing key). This can be used to approximate a desired QPS.
