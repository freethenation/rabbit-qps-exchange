...
The 'qps-delay' header (in milliseconds) delays the message before routing it on to the final queue (using the default exchange and your routing key). This can be used to approximate a desired QPS.
